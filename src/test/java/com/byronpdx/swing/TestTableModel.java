...
public class TestTableModel extends AbstractTableModel {
    ...
    private final Person[] people = { new Person("Byron", LocalDate.of(1949, 8, 27), 62), new Person("Helen", LocalDate.of(1946, 5, 16), 65),
            new Person("Nettle", LocalDate.of(1977, 7, 11), 33), new Person("Bruce", LocalDate.of(1952, 3, 23), 59) };
    ...
    public TestTableModel(final JTable table) {
        ...
        final TableColumn col = colModel.getColumn(1);
        col.setHeaderValue("DOB");
        col.setCellRenderer(new CalendarCellRenderer("MM/dd/yyyy"));
        final CalendarCellEditor editor = new CalendarCellEditor();
        ...
        editor.addDateListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                table.getModel().setValueAt(evt.getNewValue(), sorter.convertRowIndexToModel(table.getEditingRow()), table.getEditingColumn());
            }
    ...
    public Object getValueAt(int row, int col) {
        final Person person = people[row];
        switch (col) {
            case 0:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        final Person person = people[rowIndex];
        switch (columnIndex) {
            case 0:
