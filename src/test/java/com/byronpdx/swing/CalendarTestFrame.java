...
public class CalendarTestFrame extends JFrame {
    ...
    private final CalendarPanel calendarDiag;
    private final JTextField txtCalefld;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    final CalendarTestFrame frame = new CalendarTestFrame();
    ...
    public CalendarTestFrame() {
        ...
        final GridBagConstraints gbc_calendarWidget = new GridBagConstraints();
        ...
        calendarWidget.addPropertyChangeListener("date", new PropertyChangeListener() {

            @Override
            public void propertyChange(PropertyChangeEvent evt) {
                System.out.println("Date set");
                txtDate.setText(calendarWidget.getDate() == null ? "null" : calendarWidget.getDate().toString());
        ...
        calendarDiag.addPropertyChangeListener("date", new PropertyChangeListener() {
        ...
        final GridBagConstraints gbc_calendarDiag = new GridBagConstraints();
        ...
        final GridBagConstraints gbc_txtCalefld = new GridBagConstraints();
        ...
        txtCalefld.setColumns(10);
        {
            btnPrint.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    final Person[] people = ((TestTableModel) table.getModel()).getPeople();
                    for (final Person p : people) {
                        System.out.println(p);
                    }
                }
            });
            contentPane.add(btnPrint, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 5),
                    0, 0));
        }
