...
public class CalendarTableModel extends AbstractTableModel {
    ...
    private final LocalDate[][] days = new LocalDate[6][7];
    private int rows = 6;
    ...
    private void setupColumns() {
        ...
        for (int col = 0; col < 7; col++) {
            final TableColumn colmn = tcmodel.getColumn(col);
            colmn.setCellRenderer(new DefaultTableCellRenderer() {
                ...
                public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                    ...
                    if (days[row][column].getMonthValue() == month) {
    ...
    public String getColumnName(int column) {
        final DAYOFWEEK wkd = DAYOFWEEK.values()[column];
        return wkd.getAbbr();
    }
    ...
    private void setupCalendar() {
        ...
        dt = dt.minusDays(dt.getDayOfWeek().getValue());
